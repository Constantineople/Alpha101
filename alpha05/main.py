# -*- coding: utf-8 -*-
"""
Created on Thu Mar 23 22:23:29 2023
...
vwap_df = pd.read_csv(os.path.join(os.path.abspath('..'),'vwap_df.csv'),index_col = 0)
...
HuanCang_IC_s,HuanCang_IC,alpha_slice,return_slice,HuanCangRi = HuanCangIC(alpha,close_df,10,index)
...
HuanCangFenCeng_return,Cumsum_return = HuanCangFenCeng_ShouYi(data_slice,HuanCangRi,10,10)
